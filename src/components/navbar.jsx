...
function NavBar() {
  ...
  const setTheDisplay = (message) => {
    if(message === "TitlePart") setDash("TitlePart")
    else if (message === "ProjectsPart") setDash("ProjectsPart")
    else if (message === "ContactPart") setDash("ContactPart")
  }
  ...
  const handleAnimationEnd = (element) => {
    if (element === "sun" && theme === "light") {
      ...
      root.style.setProperty("--the-red", "rgba(255, 0, 0, 0.6)")
      ...
      root.style.setProperty("--the-red", "red")
  ...
  return <motion.div
    ...
    <h1 className="col-3 text-center" id="header-name" onClick={() => setTheDisplay("TitlePart")}>arshad</h1>
    <div className="col-3">
...
<svg ref={moonRef} onAnimationEnd={() => handleAnimationEnd("moon")} fill="#000000" id="Capa_2" className="hidden" width="800px" height="800px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M283.211 512c78.962 0 151.079-35.925 198.857-94.792 7.068-8.708-.639-21.43-11.562-19.35-124.203 23.654-238.262-71.576-238.262-196.954 0-72.222 38.662-138.635 101.498-174.394 9.686-5.512 7.25-20.197-3.756-22.23A258.156 258.156 0 0 0 283.211 0c-141.309 0-256 114.511-256 256 0 141.309 114.511 256 256 256z"/></svg>
    ...
    <button onClick={() => setTheDisplay("TitlePart")} className="col-1">home</button>
    <button onClick={() => setTheDisplay("ProjectsPart")} className="col-1">projects</button>
    <div onClick={() => setTheDisplay("ContactPart")} className="col-2">
      <span></span>
