        ...
        <>{isMobile ? <div><h1>ismobile</h1></div> : 
          <div id="contact">
            ...
            <motion.div 
              ...
              <img style={{opacity: "0.8"}} src='\page-pictures\photo1742210095.jpeg' className='col-8 offset-md-2 mt-4' />
