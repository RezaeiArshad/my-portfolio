...
import {dotsSvg} from './assets/title'
    ...
    <>
      {isMobile ? (
        ...
        <div id="title-name" style={{ width: "100%" }}>
          {/* this for laptop */}
          <div style={{ textAlign: "left" }} className="mt-auto mb-auto offset-md-2 p-0">
            <h2 style={{fontWeight: "bold"}} className="highlight mb-0 p-0 h2-clamp">Hello there, I'm -</h2>
            {dotsSvg}
            <div className="col-8 p-0 mt-0">
              <h1 className="name h1-clamp p-0 m-0 fade-in ms-auto col-12">Mehdi Rezaei</h1>
            </div>
            <h4 className="col-4 p-0 me-auto">{title.firstPart}</h4>
          </div>
        </div>
      )}
    </>
